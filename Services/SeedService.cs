...
namespace MovieProDemo.Services
{
    public class SeedService
    {
        ...
        private async Task SeedRolesAsync()
        {
            ...
            var adminRole = _appSettings.MovieProDemoSettings.DefaultCredentials.Role;
        ...
        private async Task SeedUsersAsync()
        {
            ...
            var credentials = _appSettings.MovieProDemoSettings.DefaultCredentials;
        ...
        private async Task SeedCollections()
        {
            ...
            {
                Name = _appSettings.MovieProDemoSettings.DefaultCollection.Name,
                Description = _appSettings.MovieProDemoSettings.DefaultCollection.Description
            });
